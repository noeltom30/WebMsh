      ...
      <div className="rounded border border-sky-200 dark:border-slate-800/80 bg-slate-50/50 dark:bg-slate-900/20 p-3 space-y-3">
        ...
        <div className="flex gap-1.5">
          ...
          <button title="Reset to Gmsh defaults"
            ...
            className="flex-1 h-7 rounded bg-white/35 backdrop-blur-md dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-[10px] font-medium text-slate-500 hover:text-slate-800 dark:hover:text-slate-300 transition">
            Reset
          </button>
        </div>
  ...
  return (
    <div onClick={() => onSelect(g.id)}
      className={`group rounded-lg border p-2.5 transition-all duration-150 cursor-pointer ${
        selected
          ? 'border-sky-400 dark:border-indigo-500/50 bg-sky-50 dark:bg-indigo-500/8 shadow-[0_0_0_1px_rgba(99,102,241,0.15)]'
          : 'border-slate-200 dark:border-slate-800/80 bg-white/35 backdrop-blur-md dark:bg-slate-900/20 hover:border-sky-300 dark:hover:border-indigo-500/30 hover:bg-sky-50/50 dark:hover:bg-indigo-500/5'
      }`}>
